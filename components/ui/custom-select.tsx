...
export default function CustomSelect({
  ...
  const baseClasses = cn(
    'flex w-full items-center justify-between gap-2 rounded-sm px-3! border outline-0 transition-all duration-200',
  ...
  return (
    <div className={fullWidth ? 'w-full ' : 'inline-block  md:min-w-[150px] max-w-[150px] w-full'} ref={selectRef}>
      {label && (
      ...
      <div className="relative">
        ...
        {/* Dropdown */}
        {isOpen && (
          <div className="absolute max-h-[140px] text-black md:min-w-[150px]! w-full z-50 mt-1 bg-white border border-gray-200 rounded-md shadow-lg overflow-auto">
            <div>
              {options.length === 0 ? (
                ...
                options.map((option, index) => (
                  <div
                    ...
                    className={cn(
                      ...
                      isValueEqual(option.value, selectedValue) && 'bg-blue-100 text-[#253a7b] font-semibold'
                    )}
