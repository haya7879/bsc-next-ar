  ...
  return (
    <div className="w-full">
      ...
      <div className="relative" ref={dropdownRef}>
        ...
        >
          {/* Country Selector */}
          <div className="country-code-selector min-w-[85px] max-md:min-w-[100px] border-r border-[#E5E7EB] rounded-l-xl cursor-pointer transition-colors duration-300">
            <div
                  ...
                  {filteredCountries.length > 0 ? (
                    filteredCountries.map((country, index) => (
                      <button
                        ...
                        type="button"
                        className={cn(
                          "country-option flex items-center gap-3 px-2! py-1.5! cursor-pointer transition-colors duration-200 hover:bg-[#fafafa] border-none bg-none w-full text-left text-xs! text-[#374151]",
